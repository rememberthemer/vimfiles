...
let g:colors_name = "ab-wombat256"
...
call <SID>X("Normal",		"cccccc",	"444444",	"none")
...
call <SID>X("VertSplit",	"555555",	"555555",	"none")
call <SID>X("StatusLine",	"f6f3e8",	"555555",	"italic")
call <SID>X("StatusLineNC",	"857b6f",	"555555",	"none")
			"Scrollbar
			"Tooltip
			"Menu
			"WildMenu
