...
call s:Hi( 'Normal',       s:abbg,  	  s:aluminium3 )
call s:Hi( 'Number',       "bg",    	  s:butter2 )
call s:Hi( 'String',       "bg",          s:butter0 )
call s:Hi( 'Comment',      "bg",          s:aluminium4, "italic" )
call s:Hi( 'Constant',     "bg",          s:butter1 )
call s:Hi( 'Boolean',      "bg",          s:orange3 )
call s:Hi( 'Identifier',   "bg",          s:skyblue1,   "NONE" )
call s:Hi( 'Statement',    "bg",          s:aluminium2, "bold" )
