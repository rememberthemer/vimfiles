...
highlight Normal guifg=grey90 guibg=gray27 gui=NONE ctermfg=250 ctermbg=235 cterm=NONE


" highlight groups
highlight Cursor guifg=black guibg=yellow gui=NONE ctermfg=16 ctermbg=226 cterm=NONE
highlight CursorLine guibg=grey20 gui=NONE ctermbg=226 cterm=NONE
...
highlight LineNr guifg=burlywood3 guibg=grey23 ctermfg=180 cterm=NONE
